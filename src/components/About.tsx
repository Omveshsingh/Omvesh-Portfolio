  ...
  return (
    <SectionWrapper id="about">
      <div className="text-center mb-16 md:mb-20">
        <h2 className="heading-section text-white mb-4">About Me</h2>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-stretch">
        ...
        <div className="bento-card lg:col-span-8 p-8 md:p-12 flex flex-col md:flex-row gap-8 items-center md:items-start relative overflow-hidden text-center md:text-left">
           ...
           <div className="shrink-0 w-40 h-40 md:w-56 md:h-64 relative rounded-[2rem] overflow-hidden border border-white/10 bg-[#050505]">
            <Image 
              src="/profile.png" 
              alt="Omvesh Singh" 
              fill 
        ...
        <div className="lg:col-span-4 grid grid-cols-2 lg:grid-cols-1 gap-6">
          <div className="bento-card p-8 flex flex-col items-center justify-center text-center">
             ...
             <div className="text-xs uppercase tracking-widest font-semibold text-zinc-500">CGPA Average</div>
          </div>
          <div className="bento-card p-8 flex flex-col items-center justify-center text-center">
             ...
             <div className="text-xs uppercase tracking-widest font-semibold text-zinc-500">Published AI Projects</div>
          </div>
        </div>
      </div>
      
      {/* Highlights Bento */}
      <div className="bento-card mt-6 p-8 md:p-10 !bg-[#0a0a0a]">
