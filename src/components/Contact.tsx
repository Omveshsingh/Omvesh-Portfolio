    ...
    <SectionWrapper id="contact">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20">
        ...
        <div className="flex flex-col justify-center">
          <h2 className="heading-jumbo text-white mb-6">
            Let&apos;s talk <br />
          ...
          <div className="grid grid-cols-2 gap-6">
            {[
              ...
              >
                <div className="w-12 h-12 rounded-[1rem] bg-white/5 border border-white/10 flex items-center justify-center text-zinc-400 group-hover:bg-purple-500 group-hover:text-white group-hover:border-purple-400 transition-all duration-300">
                  {item.icon}
                </div>
                <div>
                  <div className="text-[10px] uppercase font-bold tracking-widest text-zinc-600 mb-1">{item.label}</div>
        ...
        <div className="bento-card p-8 md:p-12 relative overflow-hidden">
          ...
          <div className="relative z-10 mb-8">
            ...
            <p className="text-zinc-400 mt-2 font-light">Fill out the form below and I&apos;ll be in touch.</p>
          </div>

          <form onSubmit={handleSubmit} className="flex flex-col gap-6 relative z-10 w-full">
            <div>
              <label htmlFor="name" className="block text-[11px] uppercase font-bold tracking-widest text-zinc-500 mb-2">Name</label>
              <input
            ...
            <div>
              <label htmlFor="email" className="block text-[11px] uppercase font-bold tracking-widest text-zinc-500 mb-2">Email Address</label>
              <input
            ...
            <div>
              <label htmlFor="message" className="block text-[11px] uppercase font-bold tracking-widest text-zinc-500 mb-2">Message</label>
              <textarea
